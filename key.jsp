...
%>
 ...
 <h1 style="color:#4dffff">Download File</h1><br>
    <form action="key1.jsp" method="post">
      Enter Key: <input type="text" name="key" Placeholder="Enter Key" required="required">
       <input type="hidden" name="fid" value="<%=fid %>" required="required">
        <input type="hidden" name="req" value="<%=reqid %>" required="required">
         <input type="hidden" name="pkey" value="<%=pkey %>" required="required">
    <br>
