...
%>
                        <center>
                          <form action=userlogback2.jsp method="post"><br>
		...
		<!-- 	<button type="reset">Reset</button> -->
            ...
            <font style="verdana" color="white"> To register,click on </font>
            <a href="ownerreg.jsp"><u><font style="color:red">Register?</font></u></a>
