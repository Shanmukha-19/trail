  ...
  <div class="container"> 
    ...
    <h1 style="color:white">Toward Efficient Encrypted Image Retrieval in Cloud Environment</h1></br>
      <ul class="nav navbar-nav">
        ...
        <li> <a href="adminlog.jsp">Cloud</a> </li>
...
<header id="header">
  <!-- <div class="intro"> -->
    ...
    <form action="usereg2.jsp" >
		
			<h2 align="center" style="color: #4dffff"> Owner Registration </h2>
			<table align="center">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td><center><input type="submit" value="Register" name="submit"></td>
			<td><input type="reset" name="reset"></center></td>
             </form>
        <br><br><br>
