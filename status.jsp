...
<table cellspacing="8" border="2" width="60%">
			<tr>
				...
				<th style="color: #4dffff"><center>fid</th>
				<th style="color: #4dffff"><center>File Name</th>
				<th style="color: #4dffff"><center>Pkey</th>
				<th style="color: #4dffff"><center>Status</th>
				<th style="color: #4dffff"><center>Download</th>
				<%
			...
			try {
				...
				PreparedStatement pstmt = con.prepareStatement("select * from req where uid=?");/* where uid=? */
	...
	<tr>
				...
				<td align="center"><font color="White"required><%=rs.getString(5)%></font></td>
			 ...
			 <a href="key.jsp?fid=<%=rs.getString(5)%>&&pkey=<%=rs.getString(3)%>&&reqid=<%=rs.getString(1)%>">
			 
			 
			 <font style="color: #1fcdff">Download</font></a>
				...
				<a href="key.jsp?pkey=<%=rs.getString(3)%>&&reqid=<%=rs.getString(1)%> ">Download </a>
