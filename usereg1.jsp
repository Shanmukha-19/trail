...
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/imageretrieval", "root", "ROOT"); 
Statement st=conn.createStatement();


String sql1="select count(*) from user where email='"+email+"' ";
...
String sql="insert into user(uname,pwd,email,phone,gen,aname)values('"+ uname+ "','"+ password+ "','"+ email+ "','"+ phone+ "','"+gen+ "','"+ aname+ "')";
