...
try
{
	...
	String sql="select count(*),uid from owner where email='"+s1+"' and pwd='"+s2+"'   ";  /*  and uid='"+s11+"' */
...
if(cnt==1)
{
	response.sendRedirect("ownerhome.jsp?msg=Login Successful");
	
}
else
{
	response.sendRedirect("ownerlog.jsp?msg=Invalid credentials. Please try again");
}
}
catch(Exception e)
{
