...
try
{
		...
		PreparedStatement ps1=con.prepareStatement("select * from upload where email='"+email+"'");
        ...
        <div class="row">
          <div class="intro-text">
            <center>
			 ...
			 <td style="border: 1px solid black"><a href="encimg.jsp?fid=<%=rs.getInt(1)%>"><font style="color: green">Download</font></a>
			</tr>
